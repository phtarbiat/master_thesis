...
static void main_lugreFriction_model_midpoint();
...
static void main_lugreFriction_model_midpoint()
{
  struct0_T r;
  double dz_k[3];
  double omega_k_tmp[3];
  double tauFVW_k[3];
  double tauF_k[3];
  double z_k[3];
  // Initialize function 'lugreFriction_model_midpoint' input arguments.
  // Initialize function input argument 'paramStruct'.
  // Initialize function input argument 'omega_k'.
  argInit_3x1_real_T(omega_k_tmp);
  // Initialize function input argument 'omega_pk'.
  // Initialize function input argument 'tauFVW_pk'.
  // Initialize function input argument 'tauLoad_k'.
  // Initialize function input argument 'T_k'.
  // Initialize function input argument 'z_pk'.
  // Initialize function input argument 'dz_pk'.
  // Call the entry-point 'lugreFriction_model_midpoint'.
  argInit_struct0_T(&r);
  lugreFriction_model_midpoint(
      &r, argInit_real_T(), omega_k_tmp, omega_k_tmp, omega_k_tmp, omega_k_tmp,
      omega_k_tmp, omega_k_tmp, omega_k_tmp, tauF_k, tauFVW_k, z_k, dz_k);
}
...
int main(int, char **)
{
  ...
  main_lugreFriction_model_midpoint();
