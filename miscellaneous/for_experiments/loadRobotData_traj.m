function expData = loadRobotData_traj(tSample, fileDir, baseFileName, fileEnding)
    ...
    % 18-20: Acceleration Sensor Data
    expData.uGrav = inputData(:, 22:24);

    % 18-20: Acceleration Sensor Data
    expData.uFbackLin = inputData(:, 25:27);

    % 18-20: Acceleration Sensor Data
    expData.uFricComp = inputData(:, 28:30);

    % 18-20: Acceleration Sensor Data
    expData.uDisObs = inputData(:, 31:33);

    % 18-20: Acceleration Sensor Data
    expData.uGes = inputData(:, 34:36);

    % 18-20: Acceleration Sensor Data
    expData.refValueVel = inputData(:, 37:39) / 1000;

    % 18-20: Acceleration Sensor Data
    expData.refValueAcc = inputData(:, 40:42) / 1000;
