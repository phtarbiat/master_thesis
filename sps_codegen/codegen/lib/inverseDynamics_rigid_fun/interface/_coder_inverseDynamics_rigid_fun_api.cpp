...
// File: _coder_inverseDynamics_rigid_fun_api.cpp
//
...
emlrtContext emlrtContextGlobal{
    ...
    "inverseDynamics_rigid_fun",                          // fFunctionName
                                   ...
                                   const mxArray **plhs)
{
  ...
  tauMotor = (real_T(*)[3])mxMalloc(sizeof(real_T[3]));
  ...
  in7 = b_emlrt_marshallIn(&st, emlrtAlias(prhs[6]), "in7");
  in8 = b_emlrt_marshallIn(&st, emlrtAlias(prhs[7]), "in8");
  in9 = b_emlrt_marshallIn(&st, emlrtAlias(prhs[8]), "in9");
  // Invoke the target function
  inverseDynamics_rigid_fun(g, *in2, *in3, *in4, *in5, *in6, *in7, *in8, *in9,
                            *tauMotor);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(*tauMotor);
}
...
void inverseDynamics_rigid_fun_atexit()
{
  ...
  inverseDynamics_rigid_fun_xil_terminate();
  inverseDynamics_rigid_fun_xil_shutdown();
...
//
// File trailer for _coder_inverseDynamics_rigid_fun_api.cpp
//
// [EOF]
//
