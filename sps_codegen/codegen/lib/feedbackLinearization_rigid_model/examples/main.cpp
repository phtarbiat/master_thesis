...
static void main_feedbackLinearization_rigid_model();
...
{
  struct0_T r;
  double theta_des_k_tmp[3];
  double u_k[3];
  // Initialize function 'feedbackLinearization_rigid_model' input arguments.
  // Initialize function input argument 'paramStruct'.
  // Initialize function input argument 'theta_des_k'.
  argInit_3x1_real_T(theta_des_k_tmp);
  // Initialize function input argument 'omega_des_k'.
  // Initialize function input argument 'domega_des_k'.
  // Initialize function input argument 'theta_k'.
  // Initialize function input argument 'omega_k'.
  // Call the entry-point 'feedbackLinearization_rigid_model'.
  argInit_struct0_T(&r);
  feedbackLinearization_rigid_model(&r, theta_des_k_tmp, theta_des_k_tmp,
                                    theta_des_k_tmp, theta_des_k_tmp,
                                    theta_des_k_tmp, u_k);
}
...
int main(int, char **)
{
  ...
  main_feedbackLinearization_rigid_model();
