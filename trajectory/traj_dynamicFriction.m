%% Creation of trajectory for identifying the dynamic friction models
%
% Philipp Tarbiat
...
OMEGA = 0.25;                                           % Velocity of trajectory
...
OUTPUT_FOLDER = ...                                     % Output folder for trajectory
    'trajectory/traj/dynamicFriction';
...
theta_max = conStruct.theta_max(AXIS) - 0.5; % Maximum and minimum allowed theta
...
omega_period = 360 / 2; % Omega of sin
theta_rise = -theta_max + OMEGA .* (timeVec_rise + sind(omega_period .* timeVec_rise));
...
save([OUTPUT_FOLDER, '/traj_dynamicFriction_axis', num2str(AXIS), '.mat'], '-struct', 'traj');
